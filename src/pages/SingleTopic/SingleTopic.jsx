            ...
            <div className='custom_container mt-16 grid grid-cols-12 gap-5'>
                <div className='col-span-8'>
                    ...
                    <div className='flex items-center gap-3 px-1 opacity-85 mt-3'>
                        ...
                        <div className='flex items-center gap-2'><span className='mb-1'><IoEye /></span> <span>9k</span></div>
                        <span className='font-extrabold text-xl'>|</span>
                        <div className='flex items-center gap-2'><span className='mb-1'><IoMdTime /></span> <span>8 min read</span></div>
                    </div>
                    <div className='rounded-xl overflow-hidden w-full mt-5'>
                        <img src="https://v1.tailwindcss.com/img/card-top.jpg" className='w-full' alt="Topic Image" />
                    </div>
                    <p className='my-3 text-lg font-thin'>On August 15th, an alarming email popped up in the inbox of Diana Pearl, a New York-based news editor. Someone in Moscow had logged into her verified Twitter account, it said. Pearl was familiar with the email content’s theme as it resembled previous automated correspondence from Twitter — featuring a minimal white background, black text, and blue links.
                ...
                <div className=' col-span-4'>
                    <h3 className='text-xl font-extrabold'>Another Topics</h3>
                </div>
            </div>
        </Page>
    )
